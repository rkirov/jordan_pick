...
theorem surfaceReplace_surfaceHarmonicOn (_hs : IsOpen s) (hg : SurfaceSubharmonicOn g s)
    (hd : IsReplaceDisk e c r s) :
...
theorem surfaceReplace_mem_Icc (_hs : IsOpen s) (hg : SurfaceSubharmonicOn g s)
